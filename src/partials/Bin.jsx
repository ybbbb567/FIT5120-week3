        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-green-400" data-aos="fade-up">
                ...
                <a className="text-black-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">See the rank of green</a>
                    </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-yellow-400" data-aos="fade-up">
                ...
                <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <a className="text-black-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">See the rank of recycle</a>
                    </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-red-500" data-aos="fade-up">
                ...
                <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <a className="text-black-600 hover:text-gray-400 transition duration-150 ease-in-out" href="#0">See the rank of garbage</a>
                    </div>
            </div>
